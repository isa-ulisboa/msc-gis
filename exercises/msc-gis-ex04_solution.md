...
ARVOREDO_NORM(X,Y,<span class="doubleunderline">OBJECTID</span>,COD_SIG_NEW,morada_ID,especie_ID,PAP,manutencao_ID,ocupacao_ID,local_tipo_ID,tipologia_ID,GlobalID)
...
MANUTENCAO("nanutencao_ID","MANUTENCAO"
)
